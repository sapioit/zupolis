 ...
 * @constant
 */
zupolis.EVENT_EFFECT_DESTROY_BUILDING = 0;
 ...
 * @constant
 */
zupolis.EVENT_EFFECT_LOSE_COINS = 1;
 ...
 * @constant
 */
zupolis.EVENT_EFFECT_GAIN_COINS = 2;
 ...
 * @type {Number}
 */
zupolis.EVENT_EFFECT_RAISE_INFLUENCE = 3;
 ...
 * @type {Number}
 */
zupolis.EVENT_EFFECT_LOWER_INFLUENCE = 4;
 ...
 * @constant
 */
zupolis.EVENT_EFFECT_LOSE_FAME = 5;
 ...
 * @constant
 */
zupolis.EVENT_EFFECT_GAIN_FAME = 6;
...
zupolis.EVENTS = [{
        ...
        description: '',
        chance: 0.0001,
        effect: zupolis.EVENT_EFFECT_DESTROY_BUILDING,
        data: {
            amount: 1
        }
    }, {
        ...
        chance: 0.001,
        effect: zupolis.EVENT_EFFECT_RAISE_INFLUENCE,
        data: {
            amount: 50,
            city: 'Rome'
        }
        ...
        chance: 0.001,
        effect: zupolis.EVENT_EFFECT_LOSE_COINS,
        data: {
            amount: 1000
        }
    }, {
        ...
        chance: 0.008,
        effect: zupolis.EVENT_EFFECT_GAIN_FAME,
        data: {
            amount: 100,
        }
    }];
