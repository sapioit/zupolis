 ...
 * @constant
 */
zupolis.SOLDIER_TYPES = {
    'Militia': {
        id: zupolis.SOLDIER_TYPE_MILITIA,
        attack: 2,
        defense: 1,
        cost: {
            coins: 100,
    ...
    'Axeman': {
        id: zupolis.SOLDIER_TYPE_AXEMAN,
        attack: 3,
        defense: 2,
        cost: {
            coins: 300,
    ...
    'Bowman': {
        id: zupolis.SOLDIER_TYPE_BOWMAN,
        attack: 6,
        defense: 1,
        cost: {
            coins: 500,
    ...
    'Pikeman': {
        id: zupolis.SOLDIER_TYPE_PIKEMAN,
        attack: 5,
        defense: 4,
        cost: {
            coins: 700,
    ...
    'Crossbowman': {
        id: zupolis.SOLDIER_TYPE_CROSSBOWMAN,
        attack: 7,
        defense: 2,
        cost: {
            coins: 1000,
    ...
    'Knight': {
        id: zupolis.SOLDIER_TYPE_KNIGHT,
        attack: 6,
        defense: 9,
        cost: {
            coins: 1500,
 ...
 * @type {Number}
 */
zupolis.SOLDIER_TYPE_MILITIA = 0;
 ...
 * @type {Number}
 */
zupolis.SOLDIER_TYPE_CROSSBOWMAN = 4;
 ...
 * @type {Number}
 */
zupolis.SOLDIER_TYPE_PIKEMAN = 5;
